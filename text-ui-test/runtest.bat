...
javac -cp "%MY_PATH%\src\main\java" -Xlint:none -d "%MY_PATH%\bin" "%MY_PATH%\src\main\java\Duke.java" "%MY_PATH%\src\main\java\Task.java" "%MY_PATH%\src\main\java\Todo.java" "%MY_PATH%\src\main\java\Deadline.java" "%MY_PATH%\src\main\java\Event.java" "%MY_PATH%\src\main\java\TaskManager.java" "%MY_PATH%\src\main\java\DukeException.java" "%MY_PATH%\src\main\java\DateTime.java"
IF ERRORLEVEL 1 (
    echo ********** BUILD FAILURE **********
    exit /b 1
)
