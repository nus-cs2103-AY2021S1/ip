...
//    }
//
//    public static void markAsDone(String description, TaskList tasks) throws DukeException {
//        String[] line = description.split(" ", 2);
//        if (line.length == 1) {
...
//        if (task_index > tasks.numTask()) {
//            throw new DukeException("Only existing tasks of index <= " + tasks.numTask() + " can be marked " +
//                    "as done!");
//        }
...
//        }
//        String deadlineDate = formatDate(description[1]);
//        Task task = new Deadline(description[0], deadlineDate);
//        taskList.add(task);
//
//        System.out.println("Got it. I've added this task:\n"
//                + task + "\n Now you have "
...
//        }
//        String eventDate = formatDate(description[1]);
//        Task task = new Event(description[0], eventDate);
//        taskList.add(task);
//
//        System.out.println("Got it. I've added this task:\n"
//                + task + "\n Now you have "
