...
/**
 * <p>The duke.task.DeadlineTask class defines the behavior of deadline task that has a
...
public class DeadlineTask extends Task {
    ...
    /**
     * Creates a duke.task.Task object that has a description and status of whether the task is done.
     *
     ...
     * @param timeToBeDoneBy A duke.task.DateAndTime object to represent the deadline.
     */
