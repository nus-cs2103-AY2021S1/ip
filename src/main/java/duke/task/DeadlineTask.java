...
public class DeadlineTask extends Task {
    ...
    /**
     * Constructs a new instance of a DeadlineTask with priority.
     * @param description Description of deadline task.
     * @param deadline Deadline of deadline task.
     * @param priority Priority of task.
     * @throws DukeException If deadline is not in the form of "dd-MM-yyyy HH:mm".
     */
    public DeadlineTask(String description, Priority priority, String deadline) throws DukeException {
