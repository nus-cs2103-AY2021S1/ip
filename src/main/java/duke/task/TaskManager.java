...
import duke.exception.OutOfBoundTaskException;
import duke.tag.Tag;

/**
 * <p>The duke.task.TaskManager class stores a task list and manages commands relevant
...
public class TaskManager {
    ...
    /**
     * Creates a duke.task.TaskManager object that stores a taskList.
     *
     ...
     *
     * @param newTask The duke.task.Task to add.
     */
     ...
     *
     * @param index The int that represents index of the task in the list.
     * @return The duke.task.Task that has the specified index.
     */
     ...
     *
     * @param tag The duke.tag.Tag to find.
