...
public class ActualEvent extends Task implements Event {
    private final LocalDateTime atTime;

    public ActualEvent(String description, String atTime) throws InvalidCommandException {
        super(description);
        try {
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            return true;
        } else if (obj instanceof ActualEvent) {
            ActualEvent o = (ActualEvent) obj;
