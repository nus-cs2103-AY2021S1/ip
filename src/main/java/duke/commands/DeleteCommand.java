...
public class DeleteCommand extends Command {
    ...
    /**
     * Initialize a DeleteCommand object.
     *
    ...
    public String execute(TaskList tasks, Ui ui, Storage storage) throws InvalidFormatDeleteException {
        checkDeleteFormat(tasks, inputArr);
        return deleteTask(parseInt(inputArr[1]), ui, tasks);
    }

    /**
     * Delete the task at that index in the list. If the index 'pos' is less than or equals to 0 or greater than
     ...
     * @return If index is valid, a string message will be displayed notifying which task has been deleted, else there
