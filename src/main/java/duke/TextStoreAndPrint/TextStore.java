...
public class TextStore {
    ...
    protected final static String commandNotFound = "Error: command does not exist :(\n" +
            "Type '!command' for list of commands and instructions";
    ...
    // Status msgs
    public final static String loadingSave = "Status: loading previous save";
    public final static String saveFound = "Status: previous save found";
    public final static String saveNotFound = "Status: no previous save found";
    public final static String savingToTextFile = "Status: saving tasks to text file";
