...
public class MainWindow extends AnchorPane {
    ...
    private final Image dukeImage = new Image(this.getClass().getResourceAsStream("/images/oldman.png"));
    ...
    private void printIntro() {
        DialogBox intro = DialogBox.getDukeDialog(Ui.GREET_MESSAGE,
                new Image(this.getClass().getResourceAsStream("/images/oldman.png")));
