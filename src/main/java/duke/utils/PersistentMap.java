...
public class PersistentMap<K, V> implements Map<K, V> {
    ...
    /** Type of the map. This is necessary due to erasure of generic types. */
    private final Type mapType;

    /**
     * Constructs a {@code PersistentMap} object with the specified file.
     *
    ...
    /**
     * Writes the current state of the map to the specified file.
     */
    ...
    /**
     * Retrieves the current state of the map from the specified file.
     *
     * @return the current state of the map.
     */
    private Map<K, V> readStateFromFile() {
        try {
    ...
    public boolean remove(Object key, Object value) {
        boolean isValueRemoved = map.remove(key, value);
        syncStateToFile();
    ...
    public boolean replace(K key, V oldValue, V newValue) {
        boolean isValueRemoved = map.replace(key, oldValue, newValue);
        syncStateToFile();
        return isValueRemoved;
    }
    ...
    public V computeIfPresent(K key, BiFunction<? super K, ? super V, ? extends V> remappingFunction) {
        V newValue = map.computeIfPresent(key, remappingFunction);
        syncStateToFile();
        return newValue;
    }
