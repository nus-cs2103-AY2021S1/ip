...
public class Ui {
    ...
    public String showWelcome() {
        return "Hello, I'm Duke \n"
                + "I can help you keep track of all your tasks!\n"
                + "How to add tasks to the list: \n"
                + "ToDo - type 'todo' followed by description \n"
                + "Deadline - type 'deadline' followed by description, "
                + "then '/by', then due date (yyyy-MM-dd) \n"
                + "Event - type 'event' followed by description,"
                + "then '/at', then timing (yyyy-MM-dd) \n"
