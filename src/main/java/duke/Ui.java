...
public class Ui {
     ...
     */
    public static String showTaskAdded(String taskDetail, int taskCount) {
     ...
     */
    public static String showTaskDone(String taskDetail) {
     ...
     */
    public static String showTasks(String taskDetails) {
     ...
     */
    public static String showDeletedTasks(String taskDetail) {
     ...
     */
    public static String showError(String err) {
        String line = "************************************************************";
