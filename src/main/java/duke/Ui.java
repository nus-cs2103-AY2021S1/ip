...
public class Ui {
    ...
    public ToDo getToDo() {
        ...
        if (detail.equals("")) {
            showError("Oops! Todo cannot be empty");
        }
    ...
    public Event getEvent() {
        ...
        if (s.trim().equals("")) {
            showError("Oops! Event cannot be empty");
        }
        String[] arr = s.split("/at");
        if (arr.length == 1) {
            showError("Oops! You need to include both detail and time.");
        }
    ...
    public Deadline getDeadline() {
        String s = sc.nextLine();
        if (s.trim().equals("")) {
            showError("Oops! Deadline cannot be empty");
        }
