...
public class Ui {
    ...
    public static String getHelpMsg() {
        String commandList = " ┗( ⊙.⊙ )┛ "
                ...
                + "\n     2.todo <task description> -- add a task"
                + "\n     3.deadline <task description> /by <task deadline - 'yyyy-MM-dd HH:mm'> "
                + "-- add a task with its deadline"
                + "\n     4.event <event description> /at <event timing - 'yyyy-MM-dd HH:mm'> "
                + "-- add an event with its timing"
                + "\n     5.done <task index> -- mark this task as done"
                + "\n     6.delete <task index> -- mark this task from task list"
                + "\n     7.find <keyword(s)> -- find all tasks in the task list which contains the keyword(s)"
