...
public enum Parser {
    ...
    /**
     * Generate the duke.command based on given secondary parameters
     ...
     */
    protected abstract Command generate(List<Task> taskList, String commandParam);

    /**
     * Translates user input to its corresponding Command
     * @param taskList The taskList which duke.command will execute on
