...
/**
 * This class represents the deadline command. When executed, the class will add the deadline task and save it locally.
 */
public class DeadlineCommand extends Command {
    ...
    /**
     * Constructs a Command for deadline with the specified task's name and date.
