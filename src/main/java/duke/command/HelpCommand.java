...
public class HelpCommand extends Command {
    ...
    public String execute(TaskList tasks, Ui ui, Storage storage) throws DukeException {
        String help = "These are the available commands:\n"
                + "deadline <description> /by <due date and time in YYYY-MM-dd HHmm format> - "
                ...
                + "event <description> /at <due date and time in YYYY-MM-DD HHmm format> - "
                ...
                + "<date and time in YYYY-MM-DD HHmm format> - sets the given task to "
