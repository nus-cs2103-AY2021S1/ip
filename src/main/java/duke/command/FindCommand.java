...
/**
 * This class represents the find command. When executed, the class will display all the task containing a
 * certain keyword.
 */
public class FindCommand extends Command {
    ...
    /**
     * Executes the FindCommand. Executing this command will prints out every task in the list that has the specified
    ...
    public String execute(TaskList tasks, Ui ui, Storage storage) {
        ui.sendMessage(ui.findTask(keyword, tasks));
