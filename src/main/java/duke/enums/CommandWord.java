...
public enum CommandWord {
    ECHO_MODE("echo", "echo help message"), TODO_CMD("todo",
                                                     "A todo keeps track of what you need to do.\n\t "
    ...
    DEADLINE_CMD("deadline",
                 "Deadlines keep track of when you need to get things done by.\n" + "The syntax for it is:\n"
                         ...
                         + "&" + " time string> is <date> <time> separated by a space character\n" + "\u2764 <date> "
                         + "can be in" + " any of the following formats: MMM dd yyy, d/M/yyyy, yyyy/M/d\n" + "\u2764 "
                         + "<time> can be " + "written as HHmm in 24h time\n" + "here's a valid example:\n \tdeadline "
                         + "world domination /by" + " 2020/12/2 2359"),
    EVENT_CMD("event", "Events keep track of when you have events.\n" + "The syntax for it is:\n"
            + "\u2764 event " + "<description of the event> /at <date & timeInfo string>\n" + "\u2764 <date & time "
            + "string>" + " is <date> " + "<timeInfo> separated by a space character\n"
    ...
    FIND_CMD("find", "type find <pattern> for Duke to fetch tasks that have the exact pattern "
            + "as a substring"),
    HELP_CMD("help",
             "type help <topic> to get more info about a topic. " + "Available topics include:\n"
                     + "\t\u2726 todo\n\t\u2726 deadline\n\t\u2726 event\n\t\u2726 bye\n\t\u2726 list"
                     + "\n\t\u2726 " + "done\n\t\u2726 find"),
