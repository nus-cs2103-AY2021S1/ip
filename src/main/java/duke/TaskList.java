 ...
 * A class that abstracts all operations regarding the task list, so that outer classes do not need to operate on a
 * <code>LinkedList</code> anymore.
 */
public class TaskList {
     ...
     * @return an <code>int</code> that is the size of the list that is currently stored in the object.
     */
    public int size() { return list.size();}

    /**
     * Mark a specified task in the current list done.
     * Mark a specified task in the current list as done. This index must be verified to be valid for the current list.
     ...
     * Remove a specified task in the current list. This index must be verified to be valid for the current list.
     ...
     * Add a given task to the current list. This task must be verified to be valid for the current list.
