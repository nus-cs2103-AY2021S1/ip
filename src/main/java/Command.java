...
public class Command {
    ...
    public static String[] processUserTaskInput(String[] array) throws DukeException {
        ...
        if (array.length <= 1) {
            if (array[0].equals("event")) {
                ...
                throw new DukeException("Invalid format error!");
            }
            ...
            if (toBreak && parser.isValidDate(date) && parser.isValidTime(time)) {
                ...
                throw new DukeException("Please use the correct format and include the " +
                        "keyword: /at");
            }
        } else if (array[0].equals("deadline")) {
            String des = "";
