...
public class Duke extends Application {
    ...
    private Scene scene;
    private Image user = new Image(this.getClass().getResourceAsStream("/images/Tuco.png"));
    private Image duke = new Image(this.getClass().getResourceAsStream("/images/DannyTrejo.png"));
