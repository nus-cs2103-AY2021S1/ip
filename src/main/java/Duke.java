...
public class Duke extends Application {
    ...
    private Image user = new Image(this.getClass().getResourceAsStream("/images/wolflaugh.png"));
    private Image duke = new Image(this.getClass().getResourceAsStream("/images/wolfunamused.png"));
