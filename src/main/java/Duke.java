...
public class Duke {
    ...
    public void todo(String input, ArrayList<Task> list) {
        ...
        if (input.isEmpty()) {
            ...
            ui.showOutput("Now you have " + list.size() + " tasks in the list.");
        }
    }

    public void deadline(String input, ArrayList<Task> list) {
    ...
    public void event(String input, ArrayList<Task> list){
    ...
    public void done(String input, ArrayList<Task> list){
        input = input.substring(4);
        if(input.isEmpty()){
    ...
    public void delete(String input, ArrayList<Task> list){
