...
public class Duke {
    ...
    public void handleDeadline(String instruction) throws DukeException {
        ...
        if (index != -1) {
            ...
            Deadline deadline = new Deadline(description, LocalDateTime.parse(by.substring(1), validFormat), false);
    ...
    public void handleEvent(String instruction) throws DukeException {
        ...
        if (index != -1) {
            ...
            Event event = new Event(description, LocalDateTime.parse(time.substring(1), validFormat), false);
            this.addEvent(event);
        } else {
            String emoji = Emoji.SMILE.toString();
