...
public class Printer {
    ...
    static void printSuccessDeleteTask(Task deletedTask, int lengthAfterDeletion) {
        ...
        String numberTasks = String.format("Now you have %s %s in the list.", lengthAfterDeletion, lengthAfterDeletion == 1 ? "task" : "tasks");
    ...
    static void printSuccessAddTask(Task toDo, int size) {
        ...
        String numberTasks = String.format("Now you have %s %s in the list.", size, size == 1 ? "task" : "tasks");
        System.out.println(numberTasks);
    }
