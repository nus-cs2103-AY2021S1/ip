 ...
 * When used as a Function, {@code apply} returns output generated by iPbot.
 * When used as a Consumer, {@code accept} discards the output (silent).
 */
public class CommandHandler implements Consumer<String>, Function<String, String> {
