...
public class AddCommandTest {
    ...
    public void AddCommandErrorTest() {
        assertThrows(WrongDateTimeFormatException.class, () -> {
            new AddCommand("deadline cs2103 project /by 26-06-2020 ").execute(new TaskList(new Storage("data/duke.txt").load()), new Ui(), new Storage("data/duke.txt"));
        });
    }
    ...
    public void AddCommandErrorTest2() {
        assertThrows(NoDateException.class, () -> {
            new AddCommand("deadline cs2103 project").execute(new TaskList(new Storage("data/duke.txt").load()), new Ui(), new Storage("data/duke.txt"));
        });
    }
    ...
    public void AddCommandErrorTest3() {
        assertThrows(NoTaskException.class, () -> {
            new AddCommand("event").execute(new TaskList(new Storage("data/duke.txt").load()), new Ui(), new Storage("data/duke.txt"));
        });
    }
}
