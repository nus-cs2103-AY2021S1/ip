...
public class DukeTaskListTest {
    ...
    public void addTasksTest() {
        ...
        String todo = "[duke.task.Todo][✘]Finish Drawing";
        String deadline = "[duke.task.Deadline][✘]Essay (by: 2020-10-11 18:00)";
        String event = "[duke.task.Event][✘]Meeting (at: 2020-06-20 14:00-16:00)";
