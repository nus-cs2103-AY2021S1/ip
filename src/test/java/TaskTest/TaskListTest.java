...
public class TaskListTest {
    ...
    public void taskListAddTest() throws DukeException {
        assertEquals(new TaskList(new Storage("data/duke.txt").load()).add("deadline cs2103 /by 2020-06-26 2359").getAddedOrDeletedTask(), new Deadline("cs2103", false, "2020-06-26 2359"));
    }

    @Test
    public void taskListDeleteTest() throws DukeException {
        assertEquals(new TaskList(new Storage("data/duke.txt").load()).delete("delete 1").getAddedOrDeletedTask(), new Deadline("cs2103 project", false, "2020-06-26 2359"));
    }
