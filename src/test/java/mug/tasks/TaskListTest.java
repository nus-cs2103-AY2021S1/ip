...
public class TaskListTest {
    ...
    public void addTask() {
        ...
        String expResult = "Got it. mug.Mug has added this task:\n"
                + "[T][\u2718] borrow book"
                + "\nNow you have "
                + 3
                + " mug.tasks in the list.";
    ...
    public void taskDone() {
        ...
        String expResult = "Congratz! mug.Mug has marked this task as done:\n"
                + "[T][\u2713] return book";
        assertEquals(expResult, actResult);
    }
    ...
    public void deleteTask() {
        ...
        String expResult = "Noted. mug.Mug has removed this task:\n"
            + "[T][\u2718] return book"
            + "\nNow you have "
            + 1
            + " mug.tasks in the list.";
    ...
    public void readList() {
        ...
        String expResult = "Here is your mug.tasks:\n"
                + "1. [T][\u2718] read book\n"
                + "2. [T][\u2718] return book\n";
        assertEquals(expResult, actResult);
    }
